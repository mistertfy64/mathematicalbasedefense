...
public class MainMenuScreen implements Screen {
    ...
    public MainMenuScreen(MathematicalBaseDefenders mathematicalBaseDefendersInstance) {
        ...
        mainMenuScreenStage.getCamera().position.set(960, 540, 0);
        // text stage
        ...
        mainMenuScreenTextStage.getCamera().position.set(960, 540, 0);
        // global stage
